...
public class DataGuildMemberRole extends RequestProcessor {
    ...
    private final Logger logger = LoggerFactory.getLogger(DataGuildMemberRole.class);
    ...
    public void get(Client client, Context ctx) {
        try(var con = getSqlConnectionPool().getConnection(); var sqlContext = getSqlConnectionPool().getContext(con)){
            ...
            logger.warn("An Error Occurred Processing DataGuildMemberRole#GET ", e);
            throw new BadRequestResponse();
        }
    }
    ...
    public void put(Client client, Context ctx) {
        try(var con = getSqlConnectionPool().getConnection(); var sqlContext = getSqlConnectionPool().getContext(con)){
            ...
            logger.warn("An Error Occurred Processing DataGuildMemberRole#PUT ", e);
            throw new BadRequestResponse();
        }
    }
    ...
    public void post(Client client, Context ctx) {
        try(var con = getSqlConnectionPool().getConnection(); var sqlContext = getSqlConnectionPool().getContext(con)){
            ...
            logger.warn("An Error Occurred Processing DataGuildMemberRole#POST ", e);
            throw new BadRequestResponse();
        }
    }
    ...
    public void delete(Client client, Context ctx) {
        try(var con = getSqlConnectionPool().getConnection(); var sqlContext = getSqlConnectionPool().getContext(con)){
            ...
            logger.warn("An Error Occurred Processing DataGuildMemberRole#DELETE ", e);
            throw new BadRequestResponse();
        }
    }
}
