			...
			if(!ctx.pathParamMap().containsKey("notificationId")){
				...
				for(TwitchnotificationsRecord twitchRecord : twitchRecords){
					jsonArray.put(new JSONObject()
						...
						.put("twitchChannelId", twitchRecord.getTwitchnotificationTwitchChannelId() != null ? twitchRecord.getTwitchnotificationTwitchChannelId() : JSONObject.NULL)
				...
				jsonObject
					...
					.put("twitchChannelId", twitchnotificationsRecord.getTwitchnotificationTwitchChannelId() != null ? twitchnotificationsRecord.getTwitchnotificationTwitchChannelId() : JSONObject.NULL)
