...
public class Keys {
    ...
    public static final UniqueKey<TranslationLanguagesRecord> TRANSLATION_LANGUAGES_LANGUAGE_ID = Internal.createUniqueKey(TranslationLanguages.TRANSLATION_LANGUAGES, DSL.name("translation languages_language_id"), new TableField[] { TranslationLanguages.TRANSLATION_LANGUAGES.LANGUAGE_ID }, true);
    public static final UniqueKey<TranslationsRecord> TRANSLATIONS_TRANSLATION_INTERNAL_ID = Internal.createUniqueKey(Translations.TRANSLATIONS, DSL.name("translations_translation_internal_id"), new TableField[] { Translations.TRANSLATIONS.TRANSLATION_INTERNAL_ID }, true);
    ...
    public static final ForeignKey<GuildsRecord, TranslationLanguagesRecord> GUILDS__GUILDS_PREFERRED_LANGUAGE_FKEY = Internal.createForeignKey(Guilds.GUILDS, DSL.name("guilds_preferred_language_fkey"), new TableField[] { Guilds.GUILDS.PREFERRED_LANGUAGE }, Keys.TRANSLATION_LANGUAGES_LANGUAGE_ID, new TableField[] { TranslationLanguages.TRANSLATION_LANGUAGES.LANGUAGE_ID }, true);
    ...
    public static final ForeignKey<TranslationsRecord, TranslationLanguagesRecord> TRANSLATIONS__TRANSLATIONS_TRANSLATION_LANGUAGE_ID_FKEY = Internal.createForeignKey(Translations.TRANSLATIONS, DSL.name("translations_translation_language_id_fkey"), new TableField[] { Translations.TRANSLATIONS.TRANSLATION_LANGUAGE_ID }, Keys.TRANSLATION_LANGUAGES_LANGUAGE_ID, new TableField[] { TranslationLanguages.TRANSLATION_LANGUAGES.LANGUAGE_ID }, true);
    ...
    public static final ForeignKey<UsersRecord, TranslationLanguagesRecord> USERS__USERS_PREFERRED_LANGUAGE_FKEY = Internal.createForeignKey(Users.USERS, DSL.name("users_preferred_language_fkey"), new TableField[] { Users.USERS.PREFERRED_LANGUAGE }, Keys.TRANSLATION_LANGUAGES_LANGUAGE_ID, new TableField[] { TranslationLanguages.TRANSLATION_LANGUAGES.LANGUAGE_ID }, true);
}
