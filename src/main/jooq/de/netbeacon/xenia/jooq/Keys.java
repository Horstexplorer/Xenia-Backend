...
public class Keys {
    ...
    public static final ForeignKey<TwitchnotificationsRecord, ChannelsRecord> TWITCHNOTIFICATIONS__TWITCHNOTIFICATIONS_TWITCHNOTIFICATION_DISCORD_CHANNEL_ID_FKEY = Internal.createForeignKey(Twitchnotifications.TWITCHNOTIFICATIONS, DSL.name("twitchnotifications_twitchnotification_discord_channel_id_fkey"), new TableField[] { Twitchnotifications.TWITCHNOTIFICATIONS.TWITCHNOTIFICATION_DISCORD_CHANNEL_ID }, Keys.CHANNELS_CHANNEL_ID, new TableField[] { Channels.CHANNELS.CHANNEL_ID }, true);
}
