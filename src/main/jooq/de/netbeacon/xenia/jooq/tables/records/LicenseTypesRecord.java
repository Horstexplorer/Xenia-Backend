...
public class LicenseTypesRecord extends UpdatableRecordImpl<LicenseTypesRecord> implements Record8<Integer, String, String, Integer, Integer, Integer, Integer, Integer> {
     ...
     */
    public LicenseTypesRecord(Integer licenseTypeId, String licenseName, String licenseDescription, Integer perkChannelLoggingC, Integer perkGuildRolesC, Integer perkMiscTagsC, Integer perkMiscNotificationsC, Integer perkMiscTwitchnotificationsC) {
        super(LicenseTypes.LICENSE_TYPES);
