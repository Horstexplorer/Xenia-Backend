...
public class ChannelAutoModRecord extends UpdatableRecordImpl<ChannelAutoModRecord> implements Record8<Long, Integer, Integer, Integer, Integer, Integer, Integer, Integer> {
    ...
    /**
     * Setter for <code>public.channel_auto_mod.filter_word_whitelist</code>.
     */
    public ChannelAutoModRecord setFilterWordWhitelist(Integer value) {
        set(2, value);
        return this;
    }

    /**
     * Getter for <code>public.channel_auto_mod.filter_word_whitelist</code>.
     */
    public Integer getFilterWordWhitelist() {
    ...
    @Override
    public Row8<Long, Integer, Integer, Integer, Integer, Integer, Integer, Integer> valuesRow() {
    ...
    public Field<Integer> field3() {
        return ChannelAutoMod.CHANNEL_AUTO_MOD.FILTER_WORD_WHITELIST;
    }
    ...
    @Override
    public ChannelAutoModRecord value8(Integer value) {
        setFilterChatFlood(value);
        return this;
    }

    @Override
    public ChannelAutoModRecord values(Long value1, Integer value2, Integer value3, Integer value4, Integer value5, Integer value6, Integer value7, Integer value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ChannelAutoModRecord(Long channelId, Integer filterWordBlacklist, Integer filterWordWhitelist, Integer filterInviteUrl, Integer filterOtherUrl, Integer filterSpecialChars, Integer filterMultilineSpam, Integer filterChatFlood) {
        super(ChannelAutoMod.CHANNEL_AUTO_MOD);

        setChannelId(channelId);
        setFilterWordBlacklist(filterWordBlacklist);
        setFilterWordWhitelist(filterWordWhitelist);
