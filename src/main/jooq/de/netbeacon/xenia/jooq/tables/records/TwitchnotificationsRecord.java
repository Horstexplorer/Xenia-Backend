...
public class TwitchnotificationsRecord extends UpdatableRecordImpl<TwitchnotificationsRecord> implements Record7<Integer, LocalDateTime, Long, Long, String, Long, String> {
    ...
    @Override
    public Row7<Integer, LocalDateTime, Long, Long, String, Long, String> valuesRow() {
    ...
    @Override
    public TwitchnotificationsRecord values(Integer value1, LocalDateTime value2, Long value3, Long value4, String value5, Long value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TwitchnotificationsRecord(Integer twitchnotificationId, LocalDateTime creationTimestamp, Long guildId, Long channelId, String twitchnotificationTwitchChannelName, Long twitchnotificationTwitchChannelId, String twitchnotificationCustomMessage) {
        super(Twitchnotifications.TWITCHNOTIFICATIONS);
