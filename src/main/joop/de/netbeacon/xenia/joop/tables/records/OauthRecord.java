...
import de.netbeacon.xenia.joop.tables.Oauth;
...
public class OauthRecord extends UpdatableRecordImpl<OauthRecord> implements Record7<Long, String, LocalDateTime, String, String, LocalDateTime, String> {
    ...
    /**
     * Setter for <code>public.oauth.local_auth_invalidation_time</code>.
     */
    public OauthRecord setLocalAuthInvalidationTime(LocalDateTime value) {
        set(2, value);
        return this;
    }

    /**
     * Getter for <code>public.oauth.local_auth_invalidation_time</code>.
     */
    public LocalDateTime getLocalAuthInvalidationTime() {
    ...
    @Override
    public Row7<Long, String, LocalDateTime, String, String, LocalDateTime, String> valuesRow() {
    ...
    public Field<LocalDateTime> field3() {
        return Oauth.OAUTH.LOCAL_AUTH_INVALIDATION_TIME;
    }
    ...
    public LocalDateTime component3() {
        return getLocalAuthInvalidationTime();
    }
    ...
    @Override
    public OauthRecord value3(LocalDateTime value) {
        setLocalAuthInvalidationTime(value);
        return this;
    }
    ...
    @Override
    public OauthRecord value6(LocalDateTime value) {
        setDiscordInvalidationTime(value);
        return this;
    }

    @Override
    public OauthRecord value7(String value) {
        setDiscordScopes(value);
        return this;
    }

    @Override
    public OauthRecord values(Long value1, String value2, LocalDateTime value3, String value4, String value5, LocalDateTime value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OauthRecord(Long userId, String localAuthHash, LocalDateTime localAuthInvalidationTime, String discordAccessToken, String discordRefreshToken, LocalDateTime discordInvalidationTime, String discordScopes) {
        super(Oauth.OAUTH);

        setUserId(userId);
        setLocalAuthHash(localAuthHash);
        setLocalAuthInvalidationTime(localAuthInvalidationTime);
