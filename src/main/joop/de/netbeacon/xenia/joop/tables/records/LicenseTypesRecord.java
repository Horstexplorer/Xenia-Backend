...
public class LicenseTypesRecord extends UpdatableRecordImpl<LicenseTypesRecord> implements Record7<Integer, String, String, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = 1816188626;
    ...
    @Override
    public LicenseTypesRecord values(Integer value1, String value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LicenseTypesRecord(Integer licenseTypeId, String licenseName, String licenseDescription, Integer perkChannelLoggingC, Integer perkGuildRolesC, Integer perkMiscTagsC, Integer perkMiscNotificationsC) {
        super(LicenseTypes.LICENSE_TYPES);
