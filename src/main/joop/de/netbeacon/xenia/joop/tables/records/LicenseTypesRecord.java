...
public class LicenseTypesRecord extends UpdatableRecordImpl<LicenseTypesRecord> implements Record5<Integer, String, String, Integer, Integer> {

    private static final long serialVersionUID = -2038806836;
    ...
    @Override
    public LicenseTypesRecord values(Integer value1, String value2, String value3, Integer value4, Integer value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LicenseTypesRecord(Integer licenseTypeId, String licenseName, String licenseDescription, Integer perkChannelLoggingC, Integer perkGuildRolesC) {
        super(LicenseTypes.LICENSE_TYPES);
