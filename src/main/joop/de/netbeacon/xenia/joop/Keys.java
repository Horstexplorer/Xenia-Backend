...
public class Keys {
    ...
    public static final UniqueKey<PermissionRecord> PERMISSION_PERMISSION_ID = Internal.createUniqueKey(Permission.PERMISSION, DSL.name("permission_permission_id"), new TableField[] { Permission.PERMISSION.PERMISSION_ID }, true);
    public static final UniqueKey<PollsRecord> POLLS_POLL_ID = Internal.createUniqueKey(Polls.POLLS, DSL.name("polls_poll_id"), new TableField[] { Polls.POLLS.POLL_ID }, true);
    public static final UniqueKey<PollsEntriesRecord> POLLS_ENTRIES_POLL_ID_USER_ID = Internal.createUniqueKey(PollsEntries.POLLS_ENTRIES, DSL.name("polls_entries_poll_id_user_id"), new TableField[] { PollsEntries.POLLS_ENTRIES.POLL_ID, PollsEntries.POLLS_ENTRIES.USER_ID }, true);
    public static final UniqueKey<PollsOptionsRecord> POLLS_OPTIONS_POLL_ID_POLL_OPTION_ID = Internal.createUniqueKey(PollsOptions.POLLS_OPTIONS, DSL.name("polls_options_poll_id_poll_option_id"), new TableField[] { PollsOptions.POLLS_OPTIONS.POLL_ID, PollsOptions.POLLS_OPTIONS.POLL_OPTION_ID }, true);
    public static final UniqueKey<RolesRecord> ROLES_GUILD_ID_ROLE_NAME = Internal.createUniqueKey(Roles.ROLES, DSL.name("roles_guild_id_role_name"), new TableField[] { Roles.ROLES.GUILD_ID, Roles.ROLES.ROLE_NAME }, true);
    public static final UniqueKey<RolesRecord> ROLES_ROLE_ID = Internal.createUniqueKey(Roles.ROLES, DSL.name("roles_role_id"), new TableField[] { Roles.ROLES.ROLE_ID }, true);
    public static final UniqueKey<RolesPermissionRecord> ROLE_PERMISSION_ROLE_ID_PERMISSION_ID = Internal.createUniqueKey(RolesPermission.ROLES_PERMISSION, DSL.name("role_permission_role_id_permission_id"), new TableField[] { RolesPermission.ROLES_PERMISSION.ROLE_ID, RolesPermission.ROLES_PERMISSION.PERMISSION_ID }, true);
    ...
    public static final ForeignKey<MembersRolesRecord, RolesRecord> MEMBERS_ROLES__MEMBERS_ROLES_ROLE_ID_FKEY = Internal.createForeignKey(MembersRoles.MEMBERS_ROLES, DSL.name("members_roles_role_id_fkey"), new TableField[] { MembersRoles.MEMBERS_ROLES.ROLE_ID }, Keys.ROLES_ROLE_ID, new TableField[] { Roles.ROLES.ROLE_ID }, true);
    ...
    public static final ForeignKey<PollsRecord, ChannelsRecord> POLLS__POLLS_CHANNEL_ID_FKEY = Internal.createForeignKey(Polls.POLLS, DSL.name("polls_channel_id_fkey"), new TableField[] { Polls.POLLS.CHANNEL_ID }, Keys.CHANNELS_CHANNEL_ID, new TableField[] { Channels.CHANNELS.CHANNEL_ID }, true);
    public static final ForeignKey<PollsRecord, GuildsRecord> POLLS__POLLS_GUILD_ID_FKEY = Internal.createForeignKey(Polls.POLLS, DSL.name("polls_guild_id_fkey"), new TableField[] { Polls.POLLS.GUILD_ID }, Keys.GUILDS_GUILD_ID, new TableField[] { Guilds.GUILDS.GUILD_ID }, true);
    public static final ForeignKey<PollsRecord, MembersRecord> POLLS__POLLS_GUILD_ID_USER_ID_FKEY = Internal.createForeignKey(Polls.POLLS, DSL.name("polls_guild_id_user_id_fkey"), new TableField[] { Polls.POLLS.GUILD_ID, Polls.POLLS.USER_ID }, Keys.MEMBERS_GUILD_ID_USER_ID, new TableField[] { Members.MEMBERS.GUILD_ID, Members.MEMBERS.USER_ID }, true);
    public static final ForeignKey<PollsRecord, UsersRecord> POLLS__POLLS_USER_ID_FKEY = Internal.createForeignKey(Polls.POLLS, DSL.name("polls_user_id_fkey"), new TableField[] { Polls.POLLS.USER_ID }, Keys.USERS_USER_ID, new TableField[] { Users.USERS.USER_ID }, true);
    public static final ForeignKey<PollsEntriesRecord, PollsRecord> POLLS_ENTRIES__POLLS_ENTRIES_POLL_ID_FKEY = Internal.createForeignKey(PollsEntries.POLLS_ENTRIES, DSL.name("polls_entries_poll_id_fkey"), new TableField[] { PollsEntries.POLLS_ENTRIES.POLL_ID }, Keys.POLLS_POLL_ID, new TableField[] { Polls.POLLS.POLL_ID }, true);
    public static final ForeignKey<PollsEntriesRecord, PollsOptionsRecord> POLLS_ENTRIES__POLLS_ENTRIES_POLL_ID_POLL_OPTION_ID_FKEY = Internal.createForeignKey(PollsEntries.POLLS_ENTRIES, DSL.name("polls_entries_poll_id_poll_option_id_fkey"), new TableField[] { PollsEntries.POLLS_ENTRIES.POLL_ID, PollsEntries.POLLS_ENTRIES.POLL_OPTION_ID }, Keys.POLLS_OPTIONS_POLL_ID_POLL_OPTION_ID, new TableField[] { PollsOptions.POLLS_OPTIONS.POLL_ID, PollsOptions.POLLS_OPTIONS.POLL_OPTION_ID }, true);
    public static final ForeignKey<PollsOptionsRecord, PollsRecord> POLLS_OPTIONS__POLLS_OPTIONS_POLL_ID_FKEY = Internal.createForeignKey(PollsOptions.POLLS_OPTIONS, DSL.name("polls_options_poll_id_fkey"), new TableField[] { PollsOptions.POLLS_OPTIONS.POLL_ID }, Keys.POLLS_POLL_ID, new TableField[] { Polls.POLLS.POLL_ID }, true);
    public static final ForeignKey<RolesPermissionRecord, PermissionRecord> ROLES_PERMISSION__ROLE_PERMISSION_PERMISSION_ID_FKEY = Internal.createForeignKey(RolesPermission.ROLES_PERMISSION, DSL.name("role_permission_permission_id_fkey"), new TableField[] { RolesPermission.ROLES_PERMISSION.PERMISSION_ID }, Keys.PERMISSION_PERMISSION_ID, new TableField[] { Permission.PERMISSION.PERMISSION_ID }, true);
    public static final ForeignKey<RolesPermissionRecord, RolesRecord> ROLES_PERMISSION__ROLE_PERMISSION_ROLE_ID_FKEY = Internal.createForeignKey(RolesPermission.ROLES_PERMISSION, DSL.name("role_permission_role_id_fkey"), new TableField[] { RolesPermission.ROLES_PERMISSION.ROLE_ID }, Keys.ROLES_ROLE_ID, new TableField[] { Roles.ROLES.ROLE_ID }, true);
